...
export const filterAffairs = (affairs: AffairType[], filter: FilterType): AffairType[] => { // need to fix any
    ...
    if(filter === 'low') filteredAffairs = affairs.filter(el => el.priority === 'low')
    if(filter === 'middle') filteredAffairs = affairs.filter(el => el.priority === 'middle')
    if(filter === 'high') filteredAffairs = affairs.filter(el => el.priority === 'high')
